...
void add_variable(std::vector <std::string> args)
{
    ...
    {
        std::cout << "[ MAIN ]:[ ADD ]:[ VALUE_IS_STRING:" << value << " ] Der Wert muss ein Integer sein!" << std::endl;
        exit(0);
    }
    ...
    else
    {
        ...
        {
            std::cout << "[ MAIN ]:[ ADD ]:[ VARIABLE_NOT_FOUND:" << value << " ] Es gibt diese Integer Variable nicht!" << std::endl;
            exit(0);
        }
    }
}
...
void sub_variable(std::vector <std::string> args)
{
    ...
    if (value.substr(0, 1) == "\"" && value.substr(value.length() - 1, value.length() - 2) == "\"")
    {
        std::cout << "[ MAIN ]:[ SUB ]:[ VALUE_IS_STRING:" << value << " ] Der Wert muss ein Integer sein!" << std::endl;
        exit(0);
    }
    else if (value.substr(0, 1) == "[" && value.substr(value.length() - 1, value.length() - 2) == "]")
    {
    ...
    else
    {
        ...
        {
            std::cout << "[ MAIN ]:[ SUB ]:[ VARIABLE_NOT_FOUND:" << value << " ] Es gibt diese Integer Variable nicht!" << std::endl;
            exit(0);
        }
    }
}
...
void mul_variable(std::vector<std::string> args)
{
    ...
    if (value.substr(0, 1) == "\"" && value.substr(value.length() - 1, value.length() - 2) == "\"")
    {
        std::cout << "[ MAIN ]:[ MUL ]:[ VALUE_IS_STRING:" << value << " ] Der Wert muss ein Integer sein!" << std::endl;
        exit(0);
    }
    else if (value.substr(0, 1) == "[" && value.substr(value.length() - 1, value.length() - 2) == "]")
    {
    ...
    else
    {
        ...
        {
            std::cout << "[ MAIN ]:[ MUL ]:[ VARIABLE_NOT_FOUND:" << value << " ] Es gibt diese Integer Variable nicht!" << std::endl;
            exit(0);
        }
    }
}
...
void div_variable(std::vector<std::string> args)
{
    ...
    if (value.substr(0, 1) == "\"" && value.substr(value.length() - 1, value.length() - 2) == "\"")
    {
        std::cout << "[ MAIN ]:[ DIV ]:[ VALUE_IS_STRING:" << value << " ] Der Wert muss ein Integer sein!" << std::endl;
        exit(0);
    }
    else if (value.substr(0, 1) == "[" && value.substr(value.length() - 1, value.length() - 2) == "]")
    {
    ...
    else
    {
        ...
        {
            std::cout << "[ MAIN ]:[ DIV ]:[ VARIABLE_NOT_FOUND:" << value << " ] Es gibt diese Integer Variable nicht!" << std::endl;
            exit(0);
        }
    }
}
